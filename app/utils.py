...
def inject_custom_css():
    ...
    *, *::before, *::after {{ box-sizing: border-box; }}
    ...
    .pipe-step.active .pipe-num {{ color:
    ...
    [data-testid="stProgressBar"] > div > div {{ background: linear-gradient(90deg, {ACCENT},
