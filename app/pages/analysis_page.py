...
def _pipeline_command():
    ...
    args.extend([
        "--match-id", str(st.session_state.get("analysis_match_id", "match_001")),
        "--home-team", str(st.session_state.get("analysis_home_team", "Home Team")),
        "--away-team", str(st.session_state.get("analysis_away_team", "Away Team")),
    ])
...
def render():
    ...
    match_id = st.text_input(
        "Match ID",
        value=st.session_state.get("analysis_match_id", "match_001"),
        key="analysis_match_id_ui",
    ...
    with meta_left:
        home_team = st.text_input(
            "Home Team Name",
            value=st.session_state.get("analysis_home_team", "Home Team"),
            key="analysis_home_team_ui",
            help="Name of the Home Team.",
        )
    with meta_right:
        away_team = st.text_input(
            "Away Team Name",
            value=st.session_state.get("analysis_away_team", "Away Team"),
            key="analysis_away_team_ui",
    ...
    st.session_state.analysis_match_id = match_id
    st.session_state.analysis_home_team = home_team
    st.session_state.analysis_away_team = away_team
