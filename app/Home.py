...
if current == "Upload":
    from app.pages import upload_page; upload_page.render()
elif current == "Preprocess":
    from app.pages import preprocess_page; preprocess_page.render()
elif current == "Analysis":
    from app.pages import analysis_page; analysis_page.render()
elif current == "Results":
    from app.pages import results_page; results_page.render()
else:
    # ══════════════════════════════════════════════════════════════════
    #  LANDING PAGE
    # ══════════════════════════════════════════════════════════════════
